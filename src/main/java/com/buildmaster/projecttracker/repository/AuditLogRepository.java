...
public interface AuditLogRepository extends MongoRepository<AuditLog, String> {
    ...
    Page<AuditLog> findByActorNameAndEntityType(String actorName, String entityType, Pageable pageable);
    ...
    @Query("{ $and: [ " +
           ...
           "] }")
    Page<AuditLog> findLogsByCriteria(String entityType, String actionType, String actorName, 
