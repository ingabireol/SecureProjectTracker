...
public interface AuditLogService {
     ...
     */
    Page<AuditLogSummaryDto> getLogsByEntityType(String entityType, Pageable pageable);
    
    /**
     * Get logs by action type
     */
    Page<AuditLogSummaryDto> getLogsByActionType(String actionType, Pageable pageable);
     ...
     */
    List<AuditLogResponseDto> getLogsForEntity(String entityType, Long entityId);
     ...
     */
    Page<AuditLogSummaryDto> searchLogs(String entityType, String actionType, 
